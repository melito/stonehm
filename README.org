#+TITLE: Keystone - Automatic OpenAPI Generation for Axum
#+AUTHOR: Keystone Contributors
#+OPTIONS: toc:2

* Overview

Keystone is a Rust library that automatically generates OpenAPI 3.0 specifications from your Axum web applications by extracting documentation directly from rustdoc comments. It provides a seamless developer experience by using the standard Axum router API while automatically capturing rich API documentation.
...
Add Keystone to your =Cargo.toml=:
